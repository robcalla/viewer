...
//				If the upload type is not setted or if it is a local upload
				...
				fileName = (fileName.lastIndexOf("/") >= 0) ? fileName.substring( fileName.lastIndexOf("/")) : fileName.substring(fileName.lastIndexOf("/")+1);
				...
				System.out.println("File Uploaded at: "+file.getAbsolutePath());
					...
					if(!("jpg".equals(ext) || "jpeg".equals(ext) || "png".equals(ext))) {
						...
						System.out.println("File Uploaded at: "+ Paths.get(getServletContext().getRealPath(filePath) + fileName));
					}				
				}
			}
